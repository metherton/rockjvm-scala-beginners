  ...
  /*
      1. Expand MyList
        - foreach method A => Unit
          [1,2,3].foreach(x => println(x))...//will print each element on a new line
        - sort function ((A, A) => Int) => MyList // Negative if first A less than second A and positive otherwise
